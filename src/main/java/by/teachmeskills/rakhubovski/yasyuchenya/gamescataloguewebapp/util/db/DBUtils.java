package by.teachmeskills.rakhubovski.yasyuchenya.gamescataloguewebapp.util.db;
...
public class DBUtils {
    ...
    public static final String url = "jdbc:mysql://localhost:3306/games_catalogue?useUnicode=true&serverTimezone=UTC&useSSL=true&verifyServerCertificate=false";
